    ...
    <>
      ...
      <AnimatePresence>
        {myBookedEvents.length === 0 ? (
          ...
          >
            <Lottie className='max-w-md w-full h-auto mx-auto' animationData={noBookedEvent} />
            <p className="text-2xl font-bold mb-5 text-gray-700 dark:text-gray-200">You haven't booked any events yet.</p>
          </motion.div>
        ) : viewMode === 'card' ? (
          <motion.div
