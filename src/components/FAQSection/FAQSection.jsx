...
const FAQSection = () => {
  ...
  const testimonials = [
    { quote: "Their attention to detail transformed our event into a masterpiece.", author: "Sarah L., Corporate Client" },
    { quote: "The team’s creativity and professionalism were unparalleled.", author: "James R., Private Client" }
  ];
