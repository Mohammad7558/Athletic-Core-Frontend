...
const Header = () => {
  ...
  <div className="modal-box w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden p-0 flex flex-col md:flex-row animate-scale-in">
    ...
    <div className="md:w-1/2 w-full px-6 py-6 relative">
      ...
      {/* Popular Tags */}
      <div className="mt-5">
        <h4 className="text-sm font-medium text-gray-600 mb-2">Popular Tags</h4>
        <div className="flex flex-wrap gap-2">
          {["Web Design", "React Developer", "Logo Design", "SEO", "Content Writing"].map(tag => (
            <span key={tag} className="badge badge-outline text-gray-600 cursor-pointer hover:bg-blue-100 hover:border-blue-300 transition">{tag}</span>
          ))}
        </div>
      </div>
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 w-80 h-full bg-base-200 z-50 shadow-lg p-4"
            >
